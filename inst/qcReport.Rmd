...
```{r cpg_discretization,echo=FALSE,warning=FALSE,message=FALSE,fig.height=10, eval=FALSE}
# CpG Discretization
...
```{r downsampling,echo=FALSE,warning=FALSE,message=FALSE,fig.height=10, eval=FALSE}
...
```{r meth_dist,echo=FALSE,warning=FALSE,message=FALSE,fig.height=10, eval=FALSE}
# Methylation distribution for all the cells
