...
```{r cpg_coverage,echo=FALSE,warning=FALSE,message=FALSE,fig.height=5}
...
```{r bs_conversion,echo=FALSE,warning=FALSE,message=FALSE,fig.height=5}
...
```{r meth_density,echo=FALSE,warning=FALSE,message=FALSE,fig.height=5, eval=FALSE}
...
```{r cpg_discretization,echo=FALSE,warning=FALSE,message=FALSE,fig.height=5, eval=TRUE}
# CpG Discretization
