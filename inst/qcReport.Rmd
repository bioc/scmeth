...
# Coverage
covVec<-scmeth::coverage(bs,subSample=params$nCpGs)
...
# CpG Discretization
discretizedCpG<-cpgDiscretization(bs,covVec,subSample=params$nCpGs)
...
##############################
# Downsample Plots
dsMatrix<-scmeth::downsample(bs,subSample=params$nCpGs)
...
# Methylation distribution for all the cells
methylDistMatrix<-scmeth::methylationDist(bs,covVec,subSample=params$nCpGs)
