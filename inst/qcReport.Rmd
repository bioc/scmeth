...
g<-ggplot2::ggplot(m, ggplot2::aes(sample, value))
g<-g+ggplot2::geom_hline(data = m, ggplot2::aes(yintercept = as.numeric(median(value))), linetype=2, color="blue")
...
g<-g+ggplot2::xlab("Sample") + ggplot2::ggtitle("Discarded CpGs from each sample after discretization")
g<-g+ggplot2::theme_bw()
g
...
g<-g+ggplot2::geom_line() + ggplot2::scale_x_continuous(name="Fraction of Reads") 
