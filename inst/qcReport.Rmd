...
ggplot2::ggplot(m, ggplot2::aes_string('Density','value')) + ggplot2::geom_line(ggplot2::aes_string(group='Sample')) + ggplot2::ggtitle("Fraction of covered CpGs by CpG density") + ggplot2::xlab("CpG coverage based on the CpG density") + ggplot2::xlab('CpG Density')+ggplot2::ylab('Fraction of CpGs')+ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 60, hjust = 1))
