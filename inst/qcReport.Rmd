...
ggplot2::ggplot(m, aes(Density,value)) + geom_line(aes(group=Sample)) + ggtitle("Fraction of covered CpGs by CpG density") + xlab("CpG coverage based on the CpG density") + xlab('CpG Density')+ylab('Fraction of CpGs')+
