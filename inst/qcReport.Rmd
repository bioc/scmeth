...
```{r read_metrics,echo=FALSE,warning=FALSE,message=FALSE,fig.height=nSamples*0.4}
...
```{r cpg_coverage,echo=FALSE,warning=FALSE,message=FALSE,fig.height=nSamples*0.4}
...
```{r bs_conversion,echo=FALSE,warning=FALSE,message=FALSE,fig.height=nSamples}
...
```{r meth_density,echo=FALSE,warning=FALSE,message=FALSE,fig.height=nSamples, eval=FALSE}
...
```{r non_rm_coverage,echo=FALSE,warning=FALSE,message=FALSE,fig.height=nSamples*0.4, eval=FALSE}
...
```{r cpg_discretization,echo=FALSE,warning=FALSE,message=FALSE,fig.height=nSamples*0.4, eval=FALSE}
# CpG Discretization
...
```{r downsampling,echo=FALSE,warning=FALSE,message=FALSE,fig.height=nSamples}
...
```{r meth_dist,echo=FALSE,warning=FALSE,message=FALSE,fig.height=nSamples, eval=FALSE}
# Methylation distribution for all the cells
