...
#'@examples
#'CpGBedGraphFile_1<-system.file("extdata",'sc-RRBS_zyg_01_chr1_CpG.bedGraph',
#'package='scmeth')
#'readMetricsFile_1<-system.file("extdata",'sc-RRBS-zygote_01.read_metrics.txt'
#',package='scmeth')
#'bsConversionFile_1<-system.file("extdata",'sc-RRBS-zygote_01.bsConv.txt',
#'package='scmeth')
#'CpGBedGraphFile_2<-system.file("extdata",'sc-RRBS_zyg_02_chr1_CpG.bedGraph',
#'package='scmeth')
#'readMetricsFile_2<-system.file("extdata",'sc-RRBS-zygote_02.read_metrics.txt'
#',package='scmeth')
#'bsConversionFile_2<-system.file("extdata",'sc-RRBS-zygote_02.bsConv.txt',
#'package='scmeth')
