...
preprocessing analysis for single-cell methylation data. This package is 
...
to individual functions, **report** function in the **scmeth** provides all 
inclusive report using most of the functions in this package. If users prefer
