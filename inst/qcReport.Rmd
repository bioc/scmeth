...
```{r mbias,echo=FALSE,warning=FALSE,message=FALSE,eval=FALSE,fig.width=8, fig.height=7,fig.align='center'}
# Methylation distribution for all the cells
scmeth::mbiasplot(dir=mbias_directory)
```
...
```{r feature_coverage,echo=FALSE,warning=FALSE,message=FALSE,fig.height=5, fig.width=5, eval=FALSE,fig.align='center'}
library(annotatr)
...
g<-g+ggplot2::stat_summary(ggplot2::aes_string(y='value', group='Var1'),fun.y=median, lwd=2,geom="point",alpha=1.0)
