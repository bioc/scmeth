...
**report** function also takes two optional arguments: subSample and offset.
With subsample parameter users can choose how many CpGs to consider in the 
analysis out of 29 million pairs (both strand) of CpGs. Our analysis have 
shown that conducting analysis with one million CpGs is suffice to capture
