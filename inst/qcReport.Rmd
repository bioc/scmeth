...
```{r read_metrics,echo=FALSE,warning=FALSE,message=FALSE,fig.width=8, fig.height=10}
...
```{r cpg_coverage,echo=FALSE,warning=FALSE,message=FALSE,fig.height=10}
...
g<-g+ggplot2::theme(panel.background = ggplot2::element_rect(fill = "white",
                    colour = "grey50"),
...
```{r bs_conversion,echo=FALSE,warning=FALSE,message=FALSE,fig.height=10}
...
```{r meth_density,echo=FALSE,warning=FALSE,message=FALSE,fig.height=10, eval=FALSE}
...
```{r cpg_discretization,echo=FALSE,warning=FALSE,message=FALSE,fig.height=10, eval=TRUE}
# CpG Discretization
...
DT::datatable(featureCovDf)
```

## Downsampling Analysis
```{r downsampling,echo=FALSE,warning=FALSE,message=FALSE,fig.height=10, eval=TRUE}
...
```{r meth_dist,echo=FALSE,warning=FALSE,message=FALSE,fig.height=10, eval=TRUE}
# Methylation distribution for all the cells
