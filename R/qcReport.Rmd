...
library(pander)
pandoc.header("Summary statistics for the read coverage", level = 2)
...
#featureCovDf<-scmeth::featureCoverage(bs,c('genes_promoters','genes_exons','genes_introns','genes_intergenic'),genome)
...
ggplot(meltedDsMatrix, aes(Var1, value, group=Var2))+ geom_line() + scale_x_continuous(name="Fraction of Reads") + scale_y_continuous(name="Number of CpG covered") + ggtitle("Saturation Analysis Plot") + theme_bw()
